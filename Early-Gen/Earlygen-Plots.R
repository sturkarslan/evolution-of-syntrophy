...
mutation.data.df <- get.modify.data(mutation.file = "/Volumes/omics4tb/sturkarslan/syntrophy_raw_sequences/dvh_mutations_allsamples_attributes_3112020.txt")

## Order based on number of mutations ##
ordered.locus.counts <- order.by.mutations()

## Order based on Gscores ##
ordered.locus.gscore <- order.by.gscore(gscores.data ="../Gscores/Gscores_high_moderate_dvh.txt")
...
#### Mm heatmap 
## Load and process mutations data ##
mutation.data.df <- get.modify.data(mutation.file = "/Volumes/omics4tb/sturkarslan/syntrophy_raw_sequences/mmp_mutations_allsamples_attributes_3112020.txt")

## Order based on number of mutations ##
ordered.locus.counts <- order.by.mutations()

## Order based on Gscores ##
ordered.locus.gscore <- order.by.gscore(gscores.data ="../Gscores/Gscores_high_moderate_mmp.txt")
